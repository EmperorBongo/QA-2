...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name('q')).sendKeys("Bronson Bowden", Key.RETURN);
  await driver.wait(until.titleIs("Bronson Bowden - Google Search"), 1000);
  ...
  await driver.findElement(By.name('q')).sendKeys("Pigeons", Key.RETURN);
  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("Pigeons - Google Search"), 1000);
});
